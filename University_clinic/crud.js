var fullNameV, ageV, genderV, addressV, emailV, cnumberV, msgcontentV, date_timeV;
...
function readFrom() {
  ...
  console.log(fullNameV, ageV, genderV, addressV, emailV, cnumberV, msgcontentV, date_timeV);
}
